...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('zinnia_blog', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, db_index=True), keep_default=False)

        # Removing unique constraint on 'Blog', fields ['blog_name']
        db.delete_unique('zinnia_blog', ['blog_name'])
    
    
    def backwards(self, orm):
        
        # Deleting field 'Blog.slug'
        db.delete_column('zinnia_blog', 'slug')

        # Adding unique constraint on 'Blog', fields ['blog_name']
        db.create_unique('zinnia_blog', ['blog_name'])
