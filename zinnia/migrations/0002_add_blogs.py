...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Blog'
        db.create_table('zinnia_blog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('blog_name', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True)),
        ))
        db.send_create_signal('zinnia', ['Blog'])

        # Adding M2M table for field authors on 'Blog'
        db.create_table('zinnia_blog_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blog', models.ForeignKey(orm['zinnia.blog'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('zinnia_blog_authors', ['blog_id', 'user_id'])

        # Adding field 'Entry.blog'
        db.add_column('zinnia_entry', 'blog', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['zinnia.Blog'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Blog'
        db.delete_table('zinnia_blog')

        # Removing M2M table for field authors on 'Blog'
        db.delete_table('zinnia_blog_authors')

        # Deleting field 'Entry.blog'
        db.delete_column('zinnia_entry', 'blog_id')
    ...
    models = {
        ...
        'zinnia.blog': {
            ...
            'blog_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'zinnia.category': {
        ...
        'zinnia.entry': {
            ...
            'blog': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zinnia.Blog']", 'null': 'True'}),
            ...
            'related': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'related_rel_+'", 'blank': 'True', 'null': 'True', 'to': "orm['zinnia.Entry']"}),
