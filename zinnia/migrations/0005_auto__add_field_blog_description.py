...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('zinnia_blog', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Blog.description'
        db.delete_column('zinnia_blog', 'description')
