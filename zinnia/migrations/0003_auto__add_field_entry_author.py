...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('zinnia_entry', 'author', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Entry.author'
        db.delete_column('zinnia_entry', 'author_id')
